...
class sdist_auto(distutils.command.sdist.sdist):
    ...
    Aims to replace the manually maintained MANIFEST.in file by providing
    information about what the source tarball created using the 'sdist' command
    should contain in normal cases.
